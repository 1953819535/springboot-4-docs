...
出处：[reference/using/auto-configuration](https://docs.spring.io/spring-boot/4.1.1/reference/using/auto-configuration.html)
...
出处：[reference/features/spring-application](https://docs.spring.io/spring-boot/4.1.1/reference/features/spring-application.html)（Application Startup tracking）、[reference/actuator/endpoints](https://docs.spring.io/spring-boot/4.1.1/reference/actuator/endpoints.html)（startup 端点）

### 端口被占用：Port 8080 was already in use

改 `server.port`，或定位并结束占用进程（Windows：`netstat -ano | findstr 8080`）。
出处：[reference/web/servlet](https://docs.spring.io/spring-boot/4.1.1/reference/web/servlet.html)
...
出处：[appendix/application-properties/index](https://docs.spring.io/spring-boot/4.1.1/appendix/application-properties.html)（allow-circular-references 默认值）
...
出处：[reference/using/build-systems](https://docs.spring.io/spring-boot/4.1.1/reference/using/build-systems.html)
...
出处：[reference/features/external-config](https://docs.spring.io/spring-boot/4.1.1/reference/features/external-config.html)
...
出处：[reference/web/servlet](https://docs.spring.io/spring-boot/4.1.1/reference/web/servlet.html)（CORS）、[reference/actuator/endpoints](https://docs.spring.io/spring-boot/4.1.1/reference/actuator/endpoints.html)（CSRF 默认开启）
...
出处：[appendix/application-properties/index](https://docs.spring.io/spring-boot/4.1.1/appendix/application-properties.html)（spring.jackson.* 键）
...
出处：[appendix/application-properties/index](https://docs.spring.io/spring-boot/4.1.1/appendix/application-properties.html)（spring.servlet.multipart.* 默认值）
...
出处：[reference/features/logging](https://docs.spring.io/spring-boot/4.1.1/reference/features/logging.html)、[appendix/application-properties/index](https://docs.spring.io/spring-boot/4.1.1/appendix/application-properties.html)（rollingpolicy 默认值）
...
出处：[reference/data/sql](https://docs.spring.io/spring-boot/4.1.1/reference/data/sql.html)
...
出处：[reference/actuator/metrics](https://docs.spring.io/spring-boot/4.1.1/reference/actuator/metrics.html)（DataSource/Hikari 指标）、[appendix/application-properties/index](https://docs.spring.io/spring-boot/4.1.1/appendix/application-properties.html)（hikari 键）
...
出处：[reference/features/task-execution-and-scheduling](https://docs.spring.io/spring-boot/4.1.1/reference/features/task-execution-and-scheduling.html)
...
出处：[reference/testing/spring-boot-applications](https://docs.spring.io/spring-boot/4.1.1/reference/testing/spring-boot-applications.html)

### 测试要 Docker：CI 环境没有 Docker 怎么办？

[Testcontainers](/glossary#testcontainers) 的集成测试需要可用的 Docker 环境，CI 没有 Docker 时要么安装 Docker/替代运行时，要么把该类测试降级为内嵌数据库版本。Docker Compose 生命周期支持默认不进测试（`spring.docker.compose.skip.in-tests` 默认 `true`）。出处：[reference/testing/testcontainers](https://docs.spring.io/spring-boot/4.1.1/reference/testing/testcontainers.html)、[appendix/application-properties/index](https://docs.spring.io/spring-boot/4.1.1/appendix/application-properties.html)（spring.docker.compose.* 默认值）

### Lombok 与 record 怎么选？

数据载体（[DTO](/glossary#dto)、配置、实体字段投影）优先 record：不可变、免 Lombok；需要可变对象或 JPA 实体仍用 class + Lombok。
出处：[reference/features/external-config](https://docs.spring.io/spring-boot/4.1.1/reference/features/external-config.html)（Lombok 生成 getter/setter 的注意事项）、`guide/ioc-di`（本手册）
